<template>
  <div class="dashboard-page">
    <div class="container">
      ...
      <div class="pending-section" v-if="userStore.isAdmin()">
        <el-alert
          title="待审核事项"
          type="warning"
          show-icon
      ...
      <div class="charts-section" v-if="userStore.isAdmin()">
      ...
      <div class="ranking-section" v-if="userStore.isAdmin()">
...
export default {
  ...
  methods: {
    ...
    goTo(type) {
      ...
      this.$router.push(pathMap[type] || '/dashboard');
    },
